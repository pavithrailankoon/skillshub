        ...
        auth.sendPasswordResetEmail(strEmail)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void unused) {
                        Toast.makeText(ChangePassword.this, "Reset password link has been sent to your registered email", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(ChangePassword.this, ClientProfileActivity.class);
                        finish();
                    }
                })
